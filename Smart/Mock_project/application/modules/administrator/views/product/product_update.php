            ...
            <?php 
                if(isset($brand) && $brand != null) {
                    foreach($brand as $listBrand) {
                        if($infoProduct['brand_id'] == $listBrand['brand_id']) {
                ...
                echo "<ul>";
                    foreach ($listThumb as $value) {
                        echo "<li class='list_thumb'>";
                            echo "<img src='/public/images/thumb/".$value['img_link']."' width='100' />";
                            echo "<a href='". base_url() . "administrator/products/deleteThumb/".$id."/". $value['img_link']."'>Delete</a>";
                        echo "</li>";
                    }
                echo "</ul>";
            }
...
<div id="insert-cancel"><input type="submit" name="update" value="Update" class="insert-cancel" />&nbsp;<input type="submit" name="cancel" value="Cancel" class="insert-cancel" /></div>
</form>